...
const stripe = require("stripe")(
  "sk_test_51Pe96DDBIOaszM2vHk5yWej4kUUo7qa7ww1uOuB855LhRSmXfzLt2TcIbJG5gTbpAgQ3R1DPylfQZltFPrIj6FvB00TSrAwI8U"
);
...
mongoose.connect(
  "mongodb+srv://kartikmaloo:kartikmaloo@kartik-project.rug2ipj.mongodb.net/kartik-Project?retryWrites=true&w=majority&appName=kartik-Project"
);
...
app.post("/create-checkout-session", async (req, res) => {
  ...
  for (let product of products) {
    if (!product.quantity || product.quantity < 1) {
      return res.status(400).json({
        error: "Each product must have a quantity greater than or equal to 1.",
      });
    }
  }
